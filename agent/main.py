...
async def entrypoint(ctx: JobContext):
    ...
    try:
        ...
        # OpenAI is already connected when avatar.start() runs. The greeting audio
        # generated by generate_reply() buffers in DataStreamAudioOutput and flushes
        # instantly when Hedra publishes its video track — no timeout.
        if avatar:
