      ...
      <div className="max-w-md w-full">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            {hasError ? (
              // Error state
              <div className="w-20 h-20 bg-red-500/20 flex items-center justify-center border-4 border-red-500/30">
              ...
              // Loading spinner
              <>
                <div className="w-20 h-20 border-4 border-gray-800 border-t-yellow-400 animate-spin" />
          ...
          <div className="mb-6 text-center">
            ...
            <div className="flex gap-3 justify-center">
              ...
              {onCancel && (
                <button
                  onClick={onCancel}
                  className="px-6 py-2.5 bg-gray-800 text-white font-semibold rounded-full hover:bg-gray-700 transition-colors"
                >
                  Voltar
                </button>
              )}
        ...
        {/* Scenario info card */}
        {scenarioTitle && (
          <div className="bg-gray-900 p-5 border-2 border-black shadow-[4px_4px_0px_#000]">
            {/* Header: Title + session type badge */}
            <div className="flex items-start justify-between gap-2 mb-3">
              <h3 className="text-lg font-semibold text-white">{scenarioTitle}</h3>
              {sessionType && (
                <span className="shrink-0 text-xs px-2.5 py-1 rounded-full bg-gray-700 text-gray-300 font-medium">
            ...
            {characterName && (
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  ...
                  {characterRole && (
                    <p className="text-xs text-gray-400">{characterRole}</p>
                  )}
                </div>
              </div>
            )}
            ...
            {/* Session tip */}
            {sessionType && (
              <div className="p-3 bg-gray-800/50 border-2 border-black">
                <p className="text-xs text-yellow-400/80 font-medium mb-1 uppercase tracking-wider">Dica</p>
